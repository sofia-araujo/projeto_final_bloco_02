    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Projeto Farmácia - Programa Generation Brasil")
                .version("v0.0.1")
                .license(new License()
                    .name("Sofia de Araújo")
                    .url("https://www.linkedin.com/in/sofia-araujo-gomes/"))
                .contact(new Contact()
                    .name("Sofia de Araújo")
                    .url("https://github.com/sofia-araujo")
